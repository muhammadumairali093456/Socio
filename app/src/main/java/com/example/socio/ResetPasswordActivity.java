    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ResetPasswordSendEmailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ResetPasswordActivity.this,"please write your valid email addresss first.....",Toast.LENGTH_LONG).show();
                }
                else
                {
                    mAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this,"please check your email account,if you want to reset your password....",Toast.LENGTH_LONG).show();
