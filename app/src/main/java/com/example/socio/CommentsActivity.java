...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PostsRef = FirebaseDatabase.getInstance("https://socio-447bc-default-rtdb.firebaseio.com/").getReference().child("Posts").child(Post_Key).child("Comments");
            ...
            PostsRef.child(RandomKey).updateChildren(commentsMap)
                    .addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task)
                        {
                            ...
                            {
                                Toast.makeText(CommentsActivity.this,"you have commented successfully....",Toast.LENGTH_SHORT);
                            }
                            else
                            {
                                Toast.makeText(CommentsActivity.this,"Error ocurred,try again........",Toast.LENGTH_SHORT);
                            }
                        }
                    });
        }
